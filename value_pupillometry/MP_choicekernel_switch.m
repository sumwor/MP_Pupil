function MP_choicekernel_switch(dataIndex,model_path)
...
print(gcf,'-dpng','CKSwitches-violin');    %png format
saveas(gcf, 'CKSwitches-violin', 'fig');
saveas(gcf, 'CKSwitches-violin','svg');
